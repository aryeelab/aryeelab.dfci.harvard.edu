...
Citations generated by Pubmed export to Bibtex (http://www.bioinformatics.org/texmed/) and then to html (https://tex.stackexchange.com/questions/171793/bibtex-to-html-markdown-etc-using-pandoc)
